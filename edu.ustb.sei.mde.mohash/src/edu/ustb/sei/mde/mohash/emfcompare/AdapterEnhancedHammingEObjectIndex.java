...
public class AdapterEnhancedHammingEObjectIndex extends HammingEObjectIndex {

	public AdapterEnhancedHammingEObjectIndex(DistanceFunction meter, ScopeQuery matcher) {
		super(meter, matcher);
	}
